...
import studio from "@/assets/green-podzim.jpg";
...
const items = [
  ...
  },
  {
    ...
    lead: "Síla, flexibilita a rozsah pohybu — hraje celé tělo, ne jen ruce.",
...
export function HloubkovyFitting() {
  return (
    <section id="hloubkovy-fitting" className="bg-card">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:px-10 lg:grid-cols-[0.9fr_1.4fr_1fr] lg:items-start lg:gap-12 lg:py-24">
        <div>
          ...
          <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
            Hloubkový fitting je proces, který jde za hranice standardních měření. Zakládám ho na
            tom, jak se hýbete, jaká jsou vaše čísla a jaký máte cíl.
          </p>
          <a
            href="#kontakt"
